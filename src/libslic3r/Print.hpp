...
public:
    ...
    std::string         export_gcode(const std::string& path_template, GCodeProcessorResult* result, ThumbnailsGeneratorCallback thumbnail_cb = nullptr, bool force = false);
    void                export_gcode_result(GCodeProcessorResult* result, ThumbnailsGeneratorCallback thumbnail_cb = nullptr);
