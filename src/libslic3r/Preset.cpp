...
static std::vector<std::string> s_Preset_filament_options {/*"filament_colour", */ "default_filament_colour", "required_nozzle_HRC", "filament_diameter", "pellet_flow_coefficient", "volumetric_speed_coefficients", "filament_type",
    ...
    "filament_flow_ratio", "filament_process_type", "filament_fiber_feed_correction", "filament_density", "filament_adhesiveness_category", "filament_cost", "filament_minimal_purge_on_wipe_tower",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "fan_kickstart", "part_cooling_fan_min_pwm", "part_cooling_fan_index", "toolchange_z_lift", "fan_speedup_time", "fan_speedup_overhangs",
    "single_extruder_multi_material", "manual_filament_change", "file_start_gcode", "machine_start_gcode", "machine_end_gcode", "before_layer_change_gcode", "printing_by_object_gcode", "layer_change_gcode", "time_lapse_gcode", "wrapping_detection_gcode", "change_filament_gcode", "change_extrusion_role_gcode",
    "fiber_cut_to_contact_length", "fiber_cut_gcode", "toolhead_fiber_e_units_per_mm", "toolhead_fiber_protocol_id",
    ...
    "nozzle_type", "nozzle_hrc","auxiliary_fan", "nozzle_volume","upward_compatible_machine", "z_hop_types", "travel_slope", "retract_lift_enforce","support_chamber_temp_control","support_air_filtration","printer_structure", "belt_gantry_angle",
