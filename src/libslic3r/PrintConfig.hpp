...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // Continuous fiber is a composite execution strategy for Orca internal
    // fill surfaces. The perimeter-named public settings below describe
    ...
    ((ConfigOptionFloat,                fiber_landing_length))
    ((ConfigOptionFloat,                fiber_landing_speed))
    ((ConfigOptionInt,                  fiber_adhesion_dwell_ms))
    ((ConfigOptionFloat,                fiber_start_speed))
    ((ConfigOptionFloat,                fiber_start_stabilization_length))
    ((ConfigOptionFloat,                fiber_finish_extension_length))
    ((ConfigOptionFloat,                fiber_outside_tolerance))
    ((ConfigOptionFloat,                fiber_contour_max_speed))
    ((ConfigOptionFloat,                fiber_infill_max_speed))
    ((ConfigOptionFloat,                fiber_contour_acceleration))
    ((ConfigOptionFloat,                fiber_contour_feed_ratio))
    ((ConfigOptionFloat,                fiber_infill_feed_ratio))
    ((ConfigOptionFloat,                fiber_contour_min_speed))
    ((ConfigOptionFloat,                fiber_infill_min_speed))
    ((ConfigOptionFloat,                fiber_corner_transition_length))
    ((ConfigOptionFloat,                fiber_speed_sampling_length))
    ((ConfigOptionFloat,                fiber_tail_min_speed))
    ((ConfigOptionFloat,                fiber_tail_max_speed))
    ((ConfigOptionFloat,                fiber_tail_speed_step_length))
    ((ConfigOptionFloat,                fiber_finish_overlap_length))
    ((ConfigOptionFloat,                fiber_finish_motion_speed))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionStrings,             filament_process_type))
    ((ConfigOptionFloats,              filament_fiber_feed_correction))
    ((ConfigOptionFloats,              toolhead_fiber_e_units_per_mm))
    ((ConfigOptionStrings,             toolhead_fiber_protocol_id))
